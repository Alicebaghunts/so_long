...
CC              = cc
CFLAGS          = -Wall -Wextra -Werror $(INCLUDES) #-fsanitize=address
...
libft:
	...
	@echo
	@echo "${GREEN}Libft Compiled ✔️${RESET}"
...
mlx:
	...
	@echo
	@echo "${GREEN}MiniLibX Compiled ✔️${RESET}"
...
$(NAME): $(OBJS)
	...
	@echo "$(CYAN)----------------------------------------------------------$(RESET)"
	@echo "$(CYAN)| $(GREEN)Usage$(GREEN)         $(CYAN)|$(CYAN) ./so_long <map_file> $(CYAN)|$(CYAN)$(RESET)"
	@echo "$(CYAN)----------------------------------------------------------$(RESET)"
	@echo "$(CYAN)| $(GREEN)Help$(GREEN)          $(CYAN)|$(CYAN) make help $(CYAN)|$(CYAN) $(RESET)"
	@echo "$(CYAN)----------------------------------------------------------$(RESET)"
