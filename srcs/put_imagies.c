...
/*   Updated: 2025/04/23 18:56:37 by alisharu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	put_images_kill(t_images *images, void *mlx)
{
	...
	images->bom_4 = mlx_xpm_file_to_image(mlx, "textures/bom_4.xpm", &w, &h);
	images->bom_5 = mlx_xpm_file_to_image(mlx, "textures/bom_5.xpm", &w, &h);
	images->bom_6 = mlx_xpm_file_to_image(mlx, "textures/bom_6.xpm", &w, &h);
	images->bom_7 = mlx_xpm_file_to_image(mlx, "textures/bom_7.xpm", &w, &h);
	images->bom_8 = mlx_xpm_file_to_image(mlx, "textures/bom_8.xpm", &w, &h);
	images->bom_9 = mlx_xpm_file_to_image(mlx, "textures/bom_9.xpm", &w, &h);
}
